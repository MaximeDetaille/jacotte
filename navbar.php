    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-margin" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li class="itemNav"><a class="smoothScroll" href="#menu"></span>Personnaliser mon menu</a></li>
                <li class="itemNav"><a class="smoothScroll" href="#qualite"></span>Produit de qualité</a></li>
